...
protected:
	...
	{
		DInt32 m_iPosIndex;
		DInt32 m_iNormalIndex;
		DInt32 m_iUvIndex;
		DInt32 m_iColorIndex;
		stIndex(){ m_iPosIndex = m_iNormalIndex = m_iUvIndex = m_iColorIndex = 0; }
		stIndex(DInt32 i1, DInt32 i2, int i3) :m_iPosIndex(i1), m_iNormalIndex(i2), m_iUvIndex(i3), m_iColorIndex(0){}
		stIndex(DInt32 i1, DInt32 i2, int i3, int i4) :m_iPosIndex(i1), m_iNormalIndex(i2), m_iUvIndex(i3), m_iColorIndex(i4){}
...
public:
	...
	virtual DexModelBase* LoadModel(const char* filename, DInt32 flag) = 0;
	virtual bool		  SaveModel(DexSkinMesh* pSkinMesh, const char* filename, DInt32 flag) = 0;
};
#endif